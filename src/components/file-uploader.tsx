...
import { LuCross, LuUpload } from "react-icons/lu"
            ...
            {isDragActive ? (
              <div className="flex flex-col items-center justify-center gap-4 sm:px-5">
                <div className="rounded-full border border-dashed p-3">
                  <LuUpload className="size-7 text-muted-foreground" aria-hidden="true" />
                </div>
  ...
  return (
    <div className="relative flex items-center space-x-4">
      ...
      <div className="flex items-center gap-2">
        <Button type="button" variant="outlined" iconOnly size="xs" onClick={onRemove}>
          <LuCross className="size-4" aria-hidden="true" />
